...
public class JwtSigner {
    ...
    public JwtSignerResponse generateToken(String username, TokenTypeEnum tokenType) {
        ...
        Date expTime = TokenTypeEnum.ACCESS_TOKEN == tokenType ? new Date(
                Instant.now()
        ...
        try {
            ...
            return JwtSignerResponse.builder().token(jwt.serialize()).expiresAt(jwtClaimsSet.getExpirationTime())
                    .build();
