...
public enum ErrorCode {
    ...
    DIRECT_INVITE_NOT_FOUND_OR_EXPIRATED(
            "DIRECT_INVITE_NOT_FOUND", "Direct invite not found", HttpStatus.NOT_FOUND),
    DIRECT_INVITE_HAS_USED(
            "DIRECT_INVITE_HAS_USED",
            "The invitation has already been used",
            HttpStatus.BAD_REQUEST),
    CANNOT_CANCEL_INVITE(
            "CANNOT_CANCEL_INVITE", "Invite not found or has been used", HttpStatus.BAD_REQUEST),
