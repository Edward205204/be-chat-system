...
public interface ServerInvitationRepository extends JpaRepository<ServerInvitation, String> {
    Optional<ServerInvitation> findByInviteeIdAndServerIdAndInviterId(String inviteeId, String serverId,String inviterId);

    Optional<ServerInvitation> findByIdAndServerIdAndInviterId(String id, String serverId, String inviterId);
    ...
    """)
    List<UserDirectInviteProjection> findUserInvitationByInviteeId(@Param("inviteeId") String inviteeId);
    ...
    """)
    int updateAllPendingByInviteeIdAndServerId(@Param("status") InviteStatusEnum status, @Param("inviteeId") String inviteeId, @Param("serverId") String serverId);
